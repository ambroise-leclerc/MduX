...
Every number from 001 to 023 appears exactly once. A superseded decision keeps its number and its
...
2. Take the next free number from the index above — currently **ADR-024**.
