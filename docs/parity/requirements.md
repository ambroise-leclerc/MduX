...
| [ADR-017](../adr/ADR-017-sibling-conformance-gate-status.md) (parity status + PAR-REQ dispositions) | MduX maintainer; domain reviewer (verifier area, PAR-REQ-002/003) | Proposed 2026-09-08 (#314d). Records the [per-capability results table](../roadmap.md#314-per-capability-conformance-results) and **proposes** PAR-REQ-001 Accepted, PAR-REQ-002 Accepted with amendment, PAR-REQ-003 Accepted with a recorded subset limitation. Ratification pending in the #314d PR. |
| PAR-REQ-001–010 | MduX maintainer; domain reviewer for any device action/risk-control interpretation | PAR-REQ-001/002/003: engineering half gated in CI by #314; ADR-017 proposes dispositions (ratification pending in the #314d PR). #313 delivered the **local** half of PAR-REQ-002; #314 Stage B the **shared-corpus** half of PAR-REQ-002 (`MEDUI-PROFILE-RENDERED` + 33 vectors + 10 manifest cases), Stage C the shared-corpus half of PAR-REQ-003 (`MEDUI-PROFILE-EVIDENCE` + 31 `aggregate-evidence` vectors + 29 `evidence` contract documents + `mdux.tools.schema`), Stage C-emitter MduX's own derived, uncommitted `MEDUI-PROFILE-RENDERED` E01 envelope. PAR-REQ-004–010 remain Proposed / unreviewed. The cross-implementation half is [#335](https://github.com/ambroise-leclerc/MduX/issues/335). |
