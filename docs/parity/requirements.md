...
| #318 interactive monitor | #316 ✓ / #317 ✓ (ADR-019) plus reviewed host action policy; PAR-REQ-006/008/009. Assembles the input→update→bind→render→capture loop (ADR-018 clause 6) over `GlfwPresentationAdapter.hpp` and two locales. Example IDs do not approve clinical behavior. |
