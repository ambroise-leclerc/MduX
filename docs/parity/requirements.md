...
[ADR-017](../adr/ADR-017-sibling-conformance-gate-status.md), 8 September 2026); PAR-REQ-004–010
remain **proposed, awaiting maintainer review**. None of them describes implemented new behavior,
...
on 8 September 2026** under #312. The verifier-area domain review for PAR-REQ-002/003 stays open,
and acceptance tests listed for the other rows remain future verification obligations.
...
[ADR-017](../adr/ADR-017-sibling-conformance-gate-status.md); PAR-REQ-004–010 stay
`Proposed / unreviewed` until the interaction, streaming and authoring work (#315–#327) reviews
them. Upstream architectural acceptance is recorded in ADR-015; consumer adoption still requires
