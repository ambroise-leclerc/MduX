...
const mdux::spec::Register samplesSpanTheBand{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RecordedListState>("trace-spans-the-band")
...
const mdux::spec::Register valueIsUp{"The larger sample is the higher one on screen", "evidence-unit", [] {
                                         return speclab::Test<RecordedListState>("trace-value-is-up")
...
const mdux::spec::Register anExtremeRangeStillSeparatesItsRails{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RecordedListState>("trace-extreme-range-separates-rails")
...
struct EveryStrokeWidthStaysInsideState {
    Scratch                                 scratch;
...
const mdux::spec::Register everyStrokeWidthStaysInside{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<EveryStrokeWidthStaysInsideState>("trace-stroke-widths-stay-inside")
            .Given("a sawtooth expanded at one, two and three pixels",
                   [](EveryStrokeWidthStaysInsideState& state) {
...
struct ExcursionsAreClampedState {
    Scratch                       scratch;
    std::optional<draw::DrawList> list;
...
const mdux::spec::Register excursionsAreClamped{"A sample outside the display range is pinned to the rail, not refused", "evidence-unit", [] {
                                                    return speclab::Test<ExcursionsAreClampedState>("trace-clamps-excursions")
                                                        .Given("samples far outside the declared range",
                                                               [](ExcursionsAreClampedState& state) {
...
const mdux::spec::Register aShortRingDrawsNothing{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RecordedListState>("trace-short-ring-draws-nothing")
...
struct AWrappedRingReadsOldestFirstState {
...
const mdux::spec::Register aWrappedRingReadsOldestFirst{"A wrapped ring is read oldest-first from its own oldest index", "evidence-unit", [] {
                                                            return speclab::Test<AWrappedRingReadsOldestFirstState>("trace-wrapped-ring-order")
                                                                .Given("a ring whose producer has wrapped past the end of its storage",
                                                                       [](AWrappedRingReadsOldestFirstState& state) {
...
const mdux::spec::Register expansionIsDeterministic{
    ...
    "determinism",
    [] {
        return speclab::Test<ExpansionIsDeterministicState>("trace-expansion-is-deterministic")
...
struct CostModelBoundsTheExpansionState {
    Scratch     scratch;
...
const mdux::spec::Register costModelBoundsTheExpansion{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<CostModelBoundsTheExpansionState>("trace-cost-model-bounds-expansion")
            .Given("a full-cap ring of distinct samples",
                   [](CostModelBoundsTheExpansionState& state) {
...
struct RefusesAnOversizedRingState {
    Scratch                       scratch;
    std::optional<draw::DrawList> list;
...
const mdux::spec::Register refusesAnOversizedRing{"A ring past the cap is refused, not truncated", "evidence-unit", [] {
                                                      return speclab::Test<RefusesAnOversizedRingState>("trace-refuses-an-oversized-ring")
                                                          .Given("a ring holding one sample more than the cap admits",
                                                                 [](RefusesAnOversizedRingState& state) {
...
const mdux::spec::Register refusesMalformedInputs{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RefusesMalformedInputsState>("trace-refuses-malformed-inputs")
...
struct ABudgetRefusalRollsBackState {
...
const mdux::spec::Register aBudgetRefusalRollsBack{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<ABudgetRefusalRollsBackState>("trace-budget-refusal-rolls-back")
            .Given("a list with room for eight quads and one rectangle already in it",
                   [](ABudgetRefusalRollsBackState& state) {
                       ...
                       Assertions::require(state.list->addSolidRect(band, nominal).has_value(), "the prior rectangle was refused");
                   })
...
const mdux::spec::Register anUnboundTraceIsUnchanged{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RenderedFrameState>("screen-unbound-trace-unchanged")
...
const mdux::spec::Register aBoundTraceDimsItsField{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<RenderedFrameState>("screen-bound-trace-dims-its-field")
...
struct AnUnboundStreamStillReservesItsFieldState {
    std::optional<ms::FrameStats> stats;
    Scratch                       scratch;
};
...
const mdux::spec::Register anUnboundStreamStillReservesItsField{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<AnUnboundStreamStillReservesItsFieldState>("screen-partially-bound-screen")
            .Given("a screen of two traces with only the first bound",
                   [](AnUnboundStreamStillReservesItsFieldState& state) {
...
const mdux::spec::Register bindingRefusesWhatItCanCheck{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<BindingRefusesWhatItCanCheckState>("screen-signal-binding-refusals")
...
const mdux::spec::Register aBindingIsNotPortableBetweenScreens{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<ABindingIsNotPortableBetweenScreensState>("screen-signal-binding-is-not-portable")
...
struct AnOversizedRingRefusesTheWholeFrameState {
    Scratch                        scratch;
    std::optional<ms::ScreenError> error;
    std::size_t                    kept{0};
};
...
const mdux::spec::Register anOversizedRingRefusesTheWholeFrame{
    ...
    "evidence-unit",
    [] {
        return speclab::Test<AnOversizedRingRefusesTheWholeFrameState>("screen-oversized-trace-refuses-the-frame")
            .Given("a screen whose bound ring holds more samples than the cap admits",
                   [](AnOversizedRingRefusesTheWholeFrameState& state) {
                       static std::array<float, ms::maxSamplesPerTrace + 1> samples{};
                       samples.fill(0.5F);
                       static const ms::SampleRing                ring = ringOver(samples);
                       static const std::array<ms::SignalSlot, 1> slots{
                       ...
                       draw::DrawList list  = state.scratch.list();
                       const auto     frame = ms::render(traceScreen, list, {}, {}, binding);
                       Assertions::require(!frame.has_value(), "the oversized trace was accepted");
                       state.error = frame.error();
