...
/// Appends one stable host-tool diagnostic.
...
/// Reads a file without text-mode translation.
...
/// Escapes one string for a generated C++ string literal.
...
/// Renders an enum through its canonical wire-value table, with an explicit bounds check.
...
/// Renders a layer-kind enumerator from the schema's load-bearing wire table.
...
/// Renders an activation enumerator from the schema's load-bearing wire table.
...
/// Renders one tensor reference as a designated initializer.
...
/// Renders one golden-vector bit table.
...
/// Renders the common namespace body shared by the module and header forms.
...
/// Renders the provenance comment shared by both generated forms.
