// Auto-generated from cube_fragment.spv
#pragma once

const unsigned char cubeFragmentShaderCodeBytes[] = {
...
constexpr size_t cubeFragmentShaderCodeSize = sizeof(cubeFragmentShaderCodeBytes);
