// Auto-generated from cube_vertex.spv
#pragma once

const unsigned char cubeVertexShaderCodeBytes[] = {
...
constexpr size_t cubeVertexShaderCodeSize = sizeof(cubeVertexShaderCodeBytes);
